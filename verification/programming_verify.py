...
from MARLlib.marllib.marl.models.zoo.mlp.base_mlp import generate_identity_matrices, separate_first_task
...
def test_separate_first_task(assignments):
...
if __name__ == '__main__':
    ...
    test_separate_first_task(assignments)
