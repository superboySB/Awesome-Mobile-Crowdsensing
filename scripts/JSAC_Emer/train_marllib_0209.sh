...
trains=(
  ...
  "--dataset SanFrancisco --selector_type RL --with_programming_optimization --tag mock_RL"
  ...
  "--dataset Chengdu --selector_type RL --with_programming_optimization --tag mock_RL"
)
