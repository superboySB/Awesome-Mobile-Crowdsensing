...
trains=(
  ...
  "--dataset SanFrancisco --reward_mode original --rl_gamma 0 --use_gdan --use_action_label --sibling_rivalry --alpha 0.3 --intrinsic_mode scaled_dis_aoi"
  "--dataset Chengdu --reward_mode original --rl_gamma 0 --use_gdan --use_action_label --sibling_rivalry --alpha 0.3 --intrinsic_mode scaled_dis_aoi"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --emergency_queue_length 5 --gen_interval 10 --tag gdan_on_policy\
