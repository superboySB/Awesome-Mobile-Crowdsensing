...
trains=(
  "--dataset SanFrancisco --surveillance_threshold 40"
  "--dataset SanFrancisco --surveillance_threshold 35"
  "--dataset SanFrancisco --surveillance_threshold 30"
  "--dataset SanFrancisco --surveillance_threshold 25"
  "--dataset SanFrancisco --surveillance_threshold 20"
  "--dataset SanFrancisco --surveillance_threshold 15"
  "--dataset Chengdu --surveillance_threshold 40"
  "--dataset Chengdu --surveillance_threshold 35"
  "--dataset Chengdu --surveillance_threshold 30"
  "--dataset Chengdu --surveillance_threshold 25"
  "--dataset Chengdu --surveillance_threshold 20"
  "--dataset Chengdu --surveillance_threshold 15"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --num_cars 0 --num_drones 4 --group baseline --algo ippo --share_policy all --switch_step 60000000\
  ...
  --display_tags dataset surveillance_threshold core_arch --reward_mode original --rl_gamma 0\
