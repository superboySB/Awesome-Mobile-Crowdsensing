...
for ((i = 0; i < train_num; i++)); do
  ...
  --num_cars 0 --group baseline --algo ippo --share_policy all --switch_step 60000000\
  ...
  --display_tags dataset num_drones core_arch --reward_mode original --rl_gamma 0\
