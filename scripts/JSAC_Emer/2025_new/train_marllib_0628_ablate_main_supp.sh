...
trains=(
  ...
  "--dataset SanFrancisco --tag ablation no_pred_and_aoi --emergency_queue_length 5 --sibling_rivalry --alpha 0.3 --intrinsic_mode dis"
  "--dataset Chengdu --tag ablation no_pred --emergency_queue_length 5 --sibling_rivalry --alpha 0.3 --intrinsic_mode scaled_dis_aoi"
  "--dataset Chengdu --tag ablation no_pred_and_aoi --emergency_queue_length 5 --sibling_rivalry --alpha 0.3 --intrinsic_mode dis"
)
