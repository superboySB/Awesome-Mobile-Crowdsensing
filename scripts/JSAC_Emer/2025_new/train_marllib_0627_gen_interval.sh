...
trains=(
  "--dataset SanFrancisco --tag gen_interval --gen_interval 3 --algo trafficppo"
  "--dataset SanFrancisco --tag gen_interval --gen_interval 6 --algo trafficppo"
  "--dataset SanFrancisco --tag gen_interval --gen_interval 10 --algo trafficppo"
  "--dataset SanFrancisco --tag gen_interval --gen_interval 15 --algo trafficppo"
  "--dataset SanFrancisco --tag gen_interval --gen_interval 20 --algo trafficppo"
  "--dataset SanFrancisco --tag gen_interval --gen_interval 30 --algo trafficppo"
  "--dataset Chengdu --tag gen_interval --gen_interval 3 --algo trafficppo"
  "--dataset Chengdu --tag gen_interval --gen_interval 6 --algo trafficppo"
  "--dataset Chengdu --tag gen_interval --gen_interval 10 --algo trafficppo"
  "--dataset Chengdu --tag gen_interval --gen_interval 15 --algo trafficppo"
  "--dataset Chengdu --tag gen_interval --gen_interval 20 --algo trafficppo"
  "--dataset Chengdu --tag gen_interval --gen_interval 30 --algo trafficppo"
)
