...
trains=(
  "--dataset SanFrancisco --tag compare_traj ours --emergency_queue_length 3 --NN_buffer --sibling_rivalry --alpha 0.7 --intrinsic_mode scaled_dis_aoi --algo trafficppo"
  "--dataset SanFrancisco --tag compare_traj ours --emergency_queue_length 3 --NN_buffer --sibling_rivalry --alpha 0.7 --intrinsic_mode aim --algo trafficppo"
  "--dataset SanFrancisco --tag compare_traj --algo ippo"
  "--dataset SanFrancisco --tag compare_traj --algo happo"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --num_drones 4 --num_cars 0 --group auto_allocation --share_policy all --switch_step 60000000\
