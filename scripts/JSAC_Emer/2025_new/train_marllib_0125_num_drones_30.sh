...
trains=(
  "--algo trafficppo --dataset Chengdu --num_drones 10 --intrinsic_mode aim --core_arch crowdsim_net"
  "--algo trafficppo --dataset Chengdu --num_drones 7 --intrinsic_mode aim --core_arch crowdsim_net"
  "--algo trafficppo --dataset Chengdu --num_drones 5 --intrinsic_mode aim --core_arch crowdsim_net"
  "--algo trafficppo --dataset Chengdu --num_drones 4 --intrinsic_mode aim --core_arch crowdsim_net"
  "--algo trafficppo --dataset Chengdu --num_drones 3 --intrinsic_mode aim --core_arch crowdsim_net"
  "--algo trafficppo --dataset Chengdu --num_drones 2 --intrinsic_mode aim --core_arch crowdsim_net"
)
