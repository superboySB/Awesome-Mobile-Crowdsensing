...
trains=(
  ...
  "--dataset SanFrancisco --reward_mode original --rl_gamma 0 --use_gdan_lstm"
  "--dataset SanFrancisco --reward_mode greedy --rl_gamma 0 --use_gdan_lstm"
  "--dataset SanFrancisco --reward_mode original --rl_gamma 0.5 --use_gdan_lstm"
  "--dataset SanFrancisco --reward_mode original --rl_gamma 0.9 --use_gdan_lstm"
)
