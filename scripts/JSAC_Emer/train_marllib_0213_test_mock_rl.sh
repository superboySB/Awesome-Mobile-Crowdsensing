...
trains=(
  "--dataset SanFrancisco --selector_type RL --gen_interval 10 --emergency_queue_length 10"
  "--dataset Chengdu --selector_type RL --emergency_queue_length 10"
  ...
  "--dataset SanFrancisco --selector_type RL --gen_interval 10 --emergency_queue_length 10 --look_ahead"
  "--dataset Chengdu --selector_type RL --emergency_queue_length 10 --look_ahead"
  "--dataset SanFrancisco --selector_type RL --gen_interval 10 --emergency_queue_length 5 --look_ahead"
  "--dataset Chengdu --selector_type RL --emergency_queue_length 5 --look_ahead"
  "--dataset SanFrancisco --selector_type RL --gen_interval 10 --emergency_queue_length 1 --look_ahead"
  "--dataset Chengdu --selector_type RL --emergency_queue_length 1 --look_ahead"
)
