#!/bin/bash
exp_name='75_anti_goal'
# not completely edited.
session_name=$exp_name
cards=(1 4 7 0 3 5 6 7)
card_num=${#cards[@]}
dry_run=false
...
trains=(
  "--dataset SanFrancisco --selector_type RL --rl_gamma 0 --emergency_queue_length 5 --gen_interval 10 --alpha 0.1"
  "--dataset SanFrancisco --selector_type RL --rl_gamma 0 --emergency_queue_length 5 --gen_interval 10 --alpha 0.5"
  "--dataset SanFrancisco --selector_type RL --rl_gamma 0 --emergency_queue_length 5 --gen_interval 10 --alpha 0.7"
  "--dataset SanFrancisco --selector_type RL --rl_gamma 0 --emergency_queue_length 5 --gen_interval 10 --alpha 1"
  "--dataset Chengdu --selector_type RL --rl_gamma 0 --emergency_queue_length 4 --alpha 0.1"
  "--dataset Chengdu --selector_type RL --rl_gamma 0 --emergency_queue_length 4 --alpha 0.5"
  "--dataset Chengdu --selector_type RL --rl_gamma 0 --emergency_queue_length 4 --alpha 0.7"
  "--dataset Chengdu --selector_type RL --rl_gamma 0 --emergency_queue_length 4 --alpha 1"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --gpu_id ${cards[card_id]} ${trains[i]} --use_2d_state --tag ablation --look_ahead --sibling_rivalry\
