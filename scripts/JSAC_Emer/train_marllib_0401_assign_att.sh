...
trains=(
  ...
  "--dataset SanFrancisco --tag restore_verify --prioritized_buffer --buffer_in_obs --reward_mode greedy --rl_gamma 0"
  "--dataset SanFrancisco --prioritized_buffer --rl_use_cnn --reward_mode original --rl_gamma 0.5"
  "--dataset SanFrancisco --prioritized_buffer --rl_use_cnn --reward_mode original --rl_gamma 0.5 --use_attention"
  "--dataset SanFrancisco --prioritized_buffer --rl_use_cnn --reward_mode original --rl_gamma 0.5 --use_attention --use_action_mask"
)
