...
trains=(
  "--dataset Chengdu --selector_type random --with_programming_optimization --gen_interval 10"
  "--dataset Chengdu --selector_type greedy --with_programming_optimization --gen_interval 10"
  ...
  "--dataset Chengdu --selector_type random --with_programming_optimization --gen_interval 10 --sibling_rivalry"
  "--dataset Chengdu --selector_type greedy --with_programming_optimization --gen_interval 10 --sibling_rivalry"
  "--dataset SanFrancisco --selector_type random --with_programming_optimization --gen_interval 10 --sibling_rivalry"
  "--dataset SanFrancisco --selector_type greedy --with_programming_optimization --gen_interval 10 --sibling_rivalry"
  "--dataset Chengdu --selector_type RL greedy --emergency_queue_length 1 --gen_interval 10"
  "--dataset Chengdu --selector_type RL greedy --emergency_queue_length 1 --gen_interval 10 --sibling_rivalry"
  "--dataset SanFrancisco --selector_type RL greedy --emergency_queue_length 1 --gen_interval 10"
  "--dataset SanFrancisco --selector_type RL greedy --emergency_queue_length 1 --gen_interval 10 --sibling_rivalry"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --gpu_id ${cards[card_id]} ${trains[i]} --use_2d_state --tag new_reward --look_ahead"
  echo "$command"
  if [ "$dry_run" = "false" ] && [ "$choice" != "n" ]
  then
