...
trains=(
  "--dataset SanFrancisco --tag attention weight_rank --prioritized_buffer"
  "--dataset SanFrancisco --tag attention weight_rank"
  "--dataset Chengdu --tag attention weight_rank --prioritized_buffer"
  "--dataset Chengdu --tag attention weight_rank"
)
