...
trains=(
  ...
  "--dataset SanFrancisco --prioritized_buffer --use_action_mask"
  "--dataset SanFrancisco --prioritized_buffer --buffer_in_obs --use_action_mask"
)
