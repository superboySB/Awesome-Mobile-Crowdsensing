...
trains=(
  "--share_policy all --selector_type NN --tolerance 0.01"
  "--share_policy all --selector_type greedy --tolerance 0.01"
  "--share_policy all --selector_type NN --tolerance 0.02"
  "--share_policy all --selector_type greedy --tolerance 0.02"
  "--share_policy all --selector_type NN --tolerance 0.05"
  "--share_policy all --selector_type greedy  --tolerance 0.05"
)
