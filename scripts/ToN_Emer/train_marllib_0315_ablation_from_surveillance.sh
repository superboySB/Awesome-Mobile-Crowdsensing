...
trains=(
  "--dataset SanFrancisco --emergency_queue_length 5 --gen_interval 10 --intrinsic_mode scaled_dis_aoi --sibling_rivalry --alpha 0.3"
  "--dataset SanFrancisco --emergency_queue_length 5 --gen_interval 10 --intrinsic_mode scaled_dis_aoi --sibling_rivalry --alpha 0.1"
  "--dataset SanFrancisco --emergency_queue_length 5 --gen_interval 10 --intrinsic_mode none"
  "--dataset SanFrancisco --emergency_queue_length 1 --gen_interval 10 --intrinsic_mode scaled_dis_aoi --sibling_rivalry --alpha 0.3"
  "--dataset SanFrancisco --emergency_queue_length 1 --gen_interval 10 --intrinsic_mode scaled_dis_aoi --sibling_rivalry --alpha 0.1"
  "--dataset SanFrancisco --emergency_queue_length 1 --gen_interval 10 --intrinsic_mode none"
  "--dataset Chengdu --emergency_queue_length 5 --gen_interval 10 --intrinsic_mode scaled_dis_aoi --sibling_rivalry --alpha 0.3"
  "--dataset Chengdu --emergency_queue_length 5 --gen_interval 10 --intrinsic_mode scaled_dis_aoi --sibling_rivalry --alpha 0.1"
  "--dataset Chengdu --emergency_queue_length 5 --gen_interval 10 --intrinsic_mode none"
  "--dataset Chengdu --emergency_queue_length 1 --gen_interval 10 --intrinsic_mode scaled_dis_aoi --sibling_rivalry --alpha 0.3"
  "--dataset Chengdu --emergency_queue_length 1 --gen_interval 10 --intrinsic_mode scaled_dis_aoi --sibling_rivalry --alpha 0.1"
  "--dataset Chengdu --emergency_queue_length 1 --gen_interval 10 --intrinsic_mode none"
)
