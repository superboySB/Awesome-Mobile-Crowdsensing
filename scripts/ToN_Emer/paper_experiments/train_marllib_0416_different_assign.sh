...
trains=(
  "--dataset SanFrancisco --selector_type RL"
  "--dataset SanFrancisco --selector_type greedy"
  "--dataset SanFrancisco --selector_type random"
  "--dataset SanFrancisco --selector_type random --no_task_allocation"
  "--dataset Chengdu --selector_type RL"
  "--dataset Chengdu --selector_type greedy"
  "--dataset Chengdu --selector_type random"
  "--dataset Chengdu --selector_type random --no_task_allocation"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --emergency_threshold 20 --speed_discount 0.8 --use_random --prioritized_buffer\
  --gen_interval 6 --cut_points 300 --tag change_assign --surveillance_threshold 35\
  --display_tags dataset selector_type  --reward_mode original --rl_gamma 0\
