...
trains=(
  "--share_policy all --selector_type NN --tolerance 0.01 --emergency_queue_length 5"
  "--share_policy all --selector_type random --tolerance 0.01 --emergency_queue_length 5"
  "--share_policy all --selector_type greedy --tolerance 0.01 --emergency_queue_length 5"
  "--share_policy all --selector_type NN --tolerance 0.05 --emergency_queue_length 5"
  "--share_policy all --selector_type random --tolerance 0.05 --emergency_queue_length 5"
  "--share_policy all --selector_type greedy  --tolerance 0.05 --emergency_queue_length 5"
  "--share_policy all --selector_type NN --tolerance 0.01 --emergency_queue_length 10"
  "--share_policy all --selector_type random --tolerance 0.01 --emergency_queue_length 10"
  "--share_policy all --selector_type greedy --tolerance 0.01 --emergency_queue_length 10"
  "--share_policy all --selector_type NN --tolerance 0.05 --emergency_queue_length 10"
  "--share_policy all --selector_type random --tolerance 0.05 --emergency_queue_length 10"
  "--share_policy all --selector_type greedy  --tolerance 0.05 --emergency_queue_length 10"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --gpu_id ${cards[card_id]} ${trains[i]} --use_2d_state --with_programming_optimization --one_agent_multi_task"
  echo "$command"
  if [ "$dry_run" = "false" ] && [ "$choice" != "n" ]
  then
