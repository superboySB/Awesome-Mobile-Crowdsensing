...
trains=(
  "--dataset SanFrancisco --reward_mode original --rl_gamma 0 --use_gdan --sibling_rivalry --alpha 0.3 --intrinsic_mode scaled_dis_aoi"
  "--dataset SanFrancisco --tag restore_verify --reward_mode original --rl_gamma 0 --sibling_rivalry --alpha 0.3 --intrinsic_mode scaled_dis_aoi"
  "--dataset SanFrancisco --reward_mode original --rl_gamma 0 --use_gdan_no_loss --sibling_rivalry --alpha 0.3 --intrinsic_mode scaled_dis_aoi"
  "--dataset SanFrancisco --reward_mode original --rl_gamma 0 --use_gdan --intrinsic_mode none"
  "--dataset SanFrancisco --reward_mode original --rl_gamma 0 --intrinsic_mode none"
  "--dataset Chengdu --reward_mode original --rl_gamma 0 --use_gdan --sibling_rivalry --alpha 0.3 --intrinsic_mode scaled_dis_aoi"
  "--dataset Chengdu --tag restore_verify --reward_mode original --rl_gamma 0 --sibling_rivalry --alpha 0.3 --intrinsic_mode scaled_dis_aoi"
  "--dataset Chengdu --reward_mode original --rl_gamma 0 --use_gdan_no_loss --sibling_rivalry --alpha 0.3 --intrinsic_mode scaled_dis_aoi"
  "--dataset Chengdu --reward_mode original --rl_gamma 0 --use_gdan --intrinsic_mode none"
  "--dataset Chengdu --reward_mode original --rl_gamma 0 --intrinsic_mode none"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --emergency_threshold 20 --speed_discount 0.5 --selector_type RL --use_random --prioritized_buffer\
  --emergency_queue_length 5 --gen_interval 10\
  --display_tags dataset reward_mode intrinsic_mode"
  echo "$command"
  if [ "$dry_run" = "false" ] && [ "$choice" != "n" ]
  then
