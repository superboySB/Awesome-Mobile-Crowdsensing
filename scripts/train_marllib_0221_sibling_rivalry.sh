...
trains=(
  ...
  "--dataset SanFrancisco --selector_type RL greedy --emergency_queue_length 3 --gen_interval 10 --sibling_rivalry"
  "--dataset SanFrancisco --selector_type RL greedy --emergency_queue_length 5 --gen_interval 10"
  "--dataset SanFrancisco --selector_type RL greedy --emergency_queue_length 5 --gen_interval 10 --sibling_rivalry"
)
