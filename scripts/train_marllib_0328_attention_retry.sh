...
trains=(
  ...
  "--dataset SanFrancisco --tag attention --prioritized_buffer --buffer_in_obs --separate_encoder --encoder_core_arch mlp"
  "--dataset SanFrancisco --tag attention --prioritized_buffer --buffer_in_obs --separate_encoder --encoder_core_arch mlp_residual"
  "--dataset SanFrancisco --tag attention --prioritized_buffer --buffer_in_obs --separate_encoder --encoder_core_arch attention"
  "--dataset SanFrancisco --tag attention --prioritized_buffer --buffer_in_obs --separate_encoder --encoder_core_arch attention_residual"
  "--dataset SanFrancisco --tag attention --prioritized_buffer --buffer_in_obs --separate_encoder --encoder_core_arch attention_gumbel"
  "--dataset SanFrancisco --tag attention --prioritized_buffer --buffer_in_obs --separate_encoder --encoder_core_arch attention_gumbel_mock"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --display_tags encoder_core_arch"
  echo "$command"
  if [ "$dry_run" = "false" ] && [ "$choice" != "n" ]
  then
