...
trains=(
  "--share_policy all --selector_type NN --gen_interval 30 --emergency_threshold 20"
  "--share_policy all --selector_type greedy --gen_interval 30 --emergency_threshold 20"
  "--share_policy all --selector_type NN --gen_interval 10 --emergency_threshold 20"
  "--share_policy all --selector_type greedy --gen_interval 10 --emergency_threshold 20"
  "--share_policy all --selector_type NN --gen_interval 30 --emergency_threshold 15"
  "--share_policy all --selector_type greedy --gen_interval 30 --emergency_threshold 15"
  "--share_policy all --selector_type NN --gen_interval 10 --emergency_threshold 15"
  "--share_policy all --selector_type greedy --gen_interval 10 --emergency_threshold 15"
  "--share_policy all --selector_type NN --gen_interval 30 --emergency_threshold 10"
  "--share_policy all --selector_type greedy --gen_interval 30 --emergency_threshold 10"
  "--share_policy all --selector_type NN --gen_interval 10 --emergency_threshold 10"
  "--share_policy all --selector_type greedy --gen_interval 10 --emergency_threshold 10"
)
