...
trains=(
  "--dataset SanFrancisco --selector_type RL --rl_gamma 0 --emergency_queue_length 1 --gen_interval 10 --ckpt 69d9c 7000 2024-02-22_16-28-54 2024-02-22_16-28-53"
  ...
  "--dataset SanFrancisco --selector_type RL --rl_gamma 0 --emergency_queue_length 1 --gen_interval 10 --reward_mode intrinsic --ckpt 69d9c 7000 2024-02-22_16-28-54 2024-02-22_16-28-53"
  "--dataset SanFrancisco --selector_type RL --rl_gamma 0 --emergency_queue_length 1 --gen_interval 10 --reward_mode none --ckpt 69d9c 7000 2024-02-22_16-28-54 2024-02-22_16-28-53"
  "--dataset SanFrancisco --selector_type RL --rl_gamma 0 --emergency_queue_length 3 --gen_interval 10 --ckpt 69d9c 7000 2024-02-22_16-28-54 2024-02-22_16-28-53"
  "--dataset SanFrancisco --selector_type RL --rl_gamma 0 --emergency_queue_length 5 --gen_interval 10 --ckpt 69d9c 7000 2024-02-22_16-28-54 2024-02-22_16-28-53"
  "--dataset Chengdu --selector_type RL --rl_gamma 0 --emergency_queue_length 1 --gen_interval 10 --ckpt 42045 7000 2024-02-22_14-33-15 2024-02-22_14-33-15"
  ...
  "--dataset Chengdu --selector_type RL --rl_gamma 0 --emergency_queue_length 1 --gen_interval 10 --reward_mode intrinsic --ckpt 42045 7000 2024-02-22_14-33-15 2024-02-22_14-33-15"
  "--dataset Chengdu --selector_type RL --rl_gamma 0 --emergency_queue_length 1 --gen_interval 10 --reward_mode none --ckpt 42045 7000 2024-02-22_14-33-15 2024-02-22_14-33-15"
...
for ((i = 0; i < train_num; i++)); do
  ...
  --gpu_id ${cards[card_id]} ${trains[i]} --use_2d_state --fail_hint --tag discrete_reward pretrain --look_ahead"
  echo "$command"
  if [ "$dry_run" = "false" ] && [ "$choice" != "n" ]
  then
