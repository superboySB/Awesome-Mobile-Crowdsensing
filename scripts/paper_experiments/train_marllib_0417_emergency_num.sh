...
trains=(
  "--dataset SanFrancisco --gen_interval 40"
  "--dataset SanFrancisco --gen_interval 30"
  "--dataset SanFrancisco --gen_interval 20"
  "--dataset SanFrancisco --gen_interval 10"
  "--dataset SanFrancisco --gen_interval 6"
  "--dataset SanFrancisco --gen_interval 3"
  "--dataset Chengdu --gen_interval 40"
  "--dataset Chengdu --gen_interval 30"
  "--dataset Chengdu --gen_interval 20"
  "--dataset Chengdu --gen_interval 10"
  "--dataset Chengdu --gen_interval 6"
  "--dataset Chengdu --gen_interval 3"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --emergency_threshold 20 --blur_requirement 2.5 --selector_type RL --use_random --prioritized_buffer\
  --cut_points 300 --tag change_emergency_num --surveillance_threshold 35\
