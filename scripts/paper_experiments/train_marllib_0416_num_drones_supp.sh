...
trains=(
  "--dataset SanFrancisco --num_drones 4 --algo happo"
  "--dataset SanFrancisco --num_drones 2 --algo happo"
  "--dataset Chengdu --num_drones 2 --algo happo"
  "--dataset Chengdu --num_drones 4 --algo happo"
  "--dataset Chengdu --num_drones 10 --algo ippo"
  "--dataset Chengdu --num_drones 5 --algo ippo"
)
...
for ((i = 0; i < train_num; i++)); do
  ...
  --num_cars 0 --group baseline --share_policy all --switch_step 60000000\
