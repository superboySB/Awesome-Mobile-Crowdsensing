...
trains=(
  "--dataset SanFrancisco --tag ablation ours --emergency_queue_length 3 --NN_buffer --sibling_rivalry --alpha 0.7 --intrinsic_mode scaled_dis_aoi"
  "--dataset SanFrancisco --tag ablation ours --emergency_queue_length 3 --NN_buffer --intrinsic_mode scaled_dis"
  "--dataset SanFrancisco --tag ablation no_buffer --emergency_queue_length 1 --sibling_rivalry --alpha 0.7 --intrinsic_mode scaled_dis_aoi"
  ...
  "--dataset Chengdu --tag ablation ours --emergency_queue_length 3 --NN_buffer --sibling_rivalry --alpha 0.7 --intrinsic_mode scaled_dis_aoi"
  "--dataset Chengdu --tag ablation ours --emergency_queue_length 3 --NN_buffer --intrinsic_mode scaled_dis"
  "--dataset Chengdu --tag ablation no_buffer --emergency_queue_length 1 --sibling_rivalry --alpha 0.7 --intrinsic_mode scaled_dis_aoi"
