...
for ((i = 0; i < train_num; i++)); do
  ...
  --num_cars 0 --num_drones 4 --group auto_allocation --algo happo --share_policy all --switch_step 60000000\
  ...
  --display_tags dataset surveillance_threshold --reward_mode original --rl_gamma 0\
