import argparse
import os
from envs.crowd_sim.crowd_sim import RLlibCrowdSim, RLlibCUDACrowdSim
...
if __name__ == '__main__':
    ...
    mappo.fit(env, model, stop={'episode_reward_mean': 2000, 'timesteps_total': 10000000}, local_mode=True, num_gpus=1,
              num_workers=8, sshare_policy='all', checkpoint_freq=10,
              ckpt_path=os.path.join("/workspace", "checkpoints", "marllib"))
