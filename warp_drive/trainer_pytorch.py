...
from envs.tag_gridworld.tag_gridworld import CUDATagGridWorld
from warp_drive.env_wrapper import EnvWrapper
from warp_drive.training.trainer import Trainer
from warp_drive.training.distributed_trainer_pycuda import (
    perform_distributed_training,
)
from warp_drive.training.vertical_scaler import perform_auto_vertical_scaling
...
if __name__ == "__main__":
    ...
    assert args.env is not None, (
        ...
        "match the name of the yaml file in run_configs/."
    )
    ...
    config_path = os.path.join(
        _ROOT_DIR, "run_configs", f"{args.env}.yaml"
    )
