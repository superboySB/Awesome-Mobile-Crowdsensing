...
run_config = dict(
    ...
    trainer=dict(
        ...
        num_episodes=500000,  # total number of episodes to run the training for (can be arbitrarily high!)
    ),
...
wandb_logger = WandbLogger(project="awesome-mcs",name="try_warpdrive")
