...
learning_rate: Union[float, list] = 8e-5
...
run_config = dict(
    ...
    policy=dict(
        car=dict(  # 无人车
            ...
            vf_loss_coefficient=1,  # loss coefficient for the value function loss
            entropy_coefficient=0.01,  # coefficient for the entropy component of the loss
        ...
        drone=dict(  # 无人机
            to_train=True,
            algorithm=algo_name,
            vf_loss_coefficient=1,
            entropy_coefficient=0.01,  # [[0, 0.5],[3000000, 0.01]]
            clip_grad_norm=True,
            max_grad_norm=0.5,
