...
all_methods = [OURS, TRADITIONAL, RL_SOTA, MCS_SOTA, GCRL_SOTA, NEW_BASELINE, RANDOM]
...
if __name__ == '__main__':
    ...
    all_data = {
        ...
        X_INTERVAL: {
            ...
            San: {
                I_emer: {
                    OURS: [np.NaN, 0.878, 0.968, 0.948, 0.956, 0.888],
                    RL_SOTA: [0.3073, 0.3198, 0.2668, 0.3131, 0.1743, 0.1794],
                    GCRL_SOTA: [0.3358, 0.3481, 0.3691, 0.3358, 0.3239, 0.3446],
                    MCS_SOTA: [0.3407, 0.3467, 0.3414, 0.3702, 0.3512, 0.3161],
                    TRADITIONAL: [0.606060606] * 6,
                    RANDOM: [0.245614035] * 6,
                ...
                I_surv: {
                    OURS: [np.NaN, 0.8539, 0.8921, 0.9051, 0.8819, 0.9064],
                    RL_SOTA: [0.9018, 0.9043, 0.9060, 0.9000, 0.9002, 0.8971],
                    GCRL_SOTA: [0.65, 0.7489, 0.8018, 0.8254, 0.8663, 0.8768],
                    MCS_SOTA: [0.5337, 0.675, 0.7655, 0.7919, 0.8426, 0.8479],
                    TRADITIONAL: [
                        0.283333333,
                ...
                eta: {
                    OURS: [np.NaN, 0.6649, 0.6636, 0.6626, 0.6542, 0.6472],
                    RL_SOTA: [0.6592, 0.6608, 0.6581, 0.6704, 0.6731, 0.6659],
                    GCRL_SOTA: [0.6669, 0.6608, 0.6623, 0.6594, 0.6593, 0.6557],
                    MCS_SOTA: [0.6663, 0.6664, 0.6654, 0.666, 0.6693, 0.6664],
                    TRADITIONAL: [0.676202787] * 6,
                    RANDOM: [0.665712714] * 6,
            ...
            Chengdu: {
                I_emer: {
                    OURS: [np.NaN, 0.94939, 0.96581, 0.97669, 0.97985, 0.97949],
                    RL_SOTA: [0.3843, 0.3583, 0.3380, 0.3370, 0.2103, 0.2137],
                    GCRL_SOTA: [0.3951, 0.6747, 0.7677, 0.8765, 0.853, 0.7695],
                    MCS_SOTA: [0.3723, 0.3877, 0.4007, 0.3804, 0.3744, 0.4151],
                    TRADITIONAL: [0.666666667] * 6,
                    RANDOM: [0.298245614] * 6,
                ...
                I_surv: {
                    OURS: [np.NaN, 0.93015, 0.94792, 0.93988, 0.93835, 0.95067],
                    RL_SOTA: [
                        0.9645, 0.9623, 0.9546, 0.9520, 0.9683, 0.9429
                    ],
                    GCRL_SOTA: [0.7388, 0.8064, 0.8743, 0.8792, 0.9264, 0.9392],
                    MCS_SOTA: [0.508, 0.6735, 0.8135, 0.836, 0.8847, 0.9121],
                    TRADITIONAL: [
                ...
                eta: {
                    OURS: [np.NaN, 0.63846, 0.67041, 0.6725, 0.6661, 0.67306],
                    RL_SOTA: [0.6720, 0.6640, 0.6578, 0.6523, 0.6505, 0.6497],
                    GCRL_SOTA: [0.6792, 0.673, 0.6739, 0.6715, 0.6715, 0.6701],
                    MCS_SOTA: [0.662, 0.6652, 0.6624, 0.6614, 0.6652, 0.6654],
                    TRADITIONAL: [0.657083523] * 6,
                    RANDOM: [0.65589873] * 6,
