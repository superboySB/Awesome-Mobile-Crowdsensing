...
class BaseEnvConfig(object):
    ...
    env.max_uav_energy = 467856 * 2
    # 359640 J <-- 359.64 kJ (4500mAh, 22.2v) 大疆经纬
    # larger: 5.7*3600*22.8=467856, https://www.dji.com/hk/matrice600
    ...
    env.end_timestamp = 1519898400
    env.energy_factor = 3  # TODO: energy factor in reward function
    env.num_timestep = (
                                   env.end_timestamp - env.start_timestamp) // env.step_time  # num_timestep x step_time = 1800s = 30min

    # TODO: San Francisco datasets
    env.lower_left = [116.22118, 39.89749]
    env.upper_right = [116.29718, 39.93374]
    env.nlon = 7910
    env.nlat = 6960
    env.human_num = 250
    env.dataset_dir = os.path.join(get_project_root(), 'datasets', 'Beijing', 'human240-for-nuo.csv')
    ...
    env.max_x_distance = 6499.627218572015
    env.max_y_distance = 4024.9466624193387
